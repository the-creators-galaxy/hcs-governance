...
function trySubmitCreateBallot(
  ...
  return new Promise((resolve, reject) => {
    if (dialog.value.open) {
      ...
      if(currentGateway.value === GatewayProvider.HashConnect &&
        ...
        payload.value = JSON.stringify({
          ...
          startTimestamp: floorOrStandoffEpochFromDate(ballotParams.startDate, network.value.minimumStandoffPeriod),
