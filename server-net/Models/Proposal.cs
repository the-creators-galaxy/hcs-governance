...
public class Proposal
{
    ...
    public Address TokenId { get; init; }
    /// <summary>
    ...
    [JsonConverter(typeof(AddressConverter))]
    public Address PayerId { get; init; }
    /// <summary>
    ...
    [JsonConverter(typeof(ConsensusTimeStampConverter))]
    public ConsensusTimeStamp StartingTimeStamp { get; init; }
    /// <summary>
    ...
    [JsonConverter(typeof(ConsensusTimeStampConverter))]
    public ConsensusTimeStamp EndingTimeStamp { get; init; }
    /// <summary>
    ...
    public decimal MinVotingThreshold { get; init; }
    /// <summary>
    ...
    public Address[] IneligibleAccounts { get; init; }
    /// <summary>
    ...
    public long[] Tally { get; protected set; } = new long[3];
    /// <summary>
    ...
    public int? Winner { get; protected set; } = null;
    /// <summary>
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string? Checksum { get; protected set; } = null;
}
